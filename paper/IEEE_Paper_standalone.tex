...
\author{
\IEEEauthorblockN{[Author Name(s) --- PLACEHOLDER: fill in before submission]}
\IEEEauthorblockA{Department of Computer Science / Information Technology\\
Ajeenkya DY Patil School of Engineering, Pune, India\\
Email: [institutional email --- PLACEHOLDER]}
\and
\IEEEauthorblockN{[Guide Name --- PLACEHOLDER: fill in before submission]}
\IEEEauthorblockA{Department of Computer Science / Information Technology\\
Ajeenkya DY Patil School of Engineering, Pune, India}
}
...
\begin{equation}
\hat{q}_{i,\ell} = \mathrm{clip}\!\left(\mathrm{round}\!\left(\frac{C_i(\sigma(\ell))}{\Delta_\ell}\right), -128, 127\right), \quad \ell=1,\dots,12,
\label{eq:quant}
\end{equation}
...
% SELF-CONTAINED BUILD -- generated by src/make_standalone.py from
...
\centering
% ---- inlined from output/tables/imperceptibility.tex (generated by make_tables.py) ----
